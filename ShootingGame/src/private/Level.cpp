...
void Level::render() {
    ...
    model = glm::translate(model, glm::vec3(-3.0f, 1.001f, -3.0f));
    model = glm::scale(model, glm::vec3(3.f));
    shader.setUnifromMat4f("model", model);
    glDrawArrays(GL_TRIANGLES, 0, 36);
    model = glm::mat4(1.0f);
    model = glm::translate(model, glm::vec3(3.0f, 1.001f, 2.0f));
    model = glm::scale(model, glm::vec3(3.f));
    shader.setUnifromMat4f("model", model);
    glDrawArrays(GL_TRIANGLES, 0, 36);
    model = glm::mat4(1.0f);
    model = glm::translate(model, glm::vec3(5.0f, 1.001f, -4.0f));
    model = glm::scale(model, glm::vec3(3.f));
    shader.setUnifromMat4f("model", model);
    glDrawArrays(GL_TRIANGLES, 0, 36);
